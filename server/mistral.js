...
let mistral = new MistralClient(apiKeys[currentApiKeyIndex]);
...
async function handleNewMessage(client, message) {
  try {
    ...
    console.log(params);
    const chatCompletion = await mistral.chat(params);
...
function switchApiKey() {
  ...
  mistral = new MistralClient(apiKeys[currentApiKeyIndex]);
